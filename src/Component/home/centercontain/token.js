...
function createData(state, tokens, tokenName, price, tokenAmount, rate, pcv2, time, timeZone, tx, txName) {
  return {state, tokens, tokenName, price, tokenAmount, rate, pcv2, time, timeZone, tx, txName };
}

const rows = [
  createData('Buy', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
  createData('Sell', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
  createData('Sell', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
  createData('Sell', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
  createData('Buy', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
  createData('Buy', '0.5855', 'POOCOIN', '$1.5', '0.0042 BNB', '$2.57', 'Pc v2' , '3:24:08', 'PM', '0x49', 'Track'),
