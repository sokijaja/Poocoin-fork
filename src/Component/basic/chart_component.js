...
const CONTAINER_ID = 'tradingview';
...
export default class TradingViewWidget extends React.Component {
  ...
  static defaultProps = {
    ...
    datafeed: [{ "open": 0.00003761064582972825, "close": 0.00003761064582972825, "high": 0.00003779989625632004, "low": 0.00003761064582972825, "volume": 11616.931097290822, "count": 2, "time": "2021-09-04T14:30:00.000Z", "baseOpen": 500.4963149353967, "baseClose": 500.8646407998523, "baseHigh": 501.1586263959321, "baseLow": 497.68438559597325 }, { "open": 0.00003779879798400148, "close": 0.0000377475621492832, "high": 0.00003779879798400148, "low": 0.00003755460909928073, "volume": 97256.49924921864, "count": 7, "time": "2021-09-04T14:45:00.000Z", "baseOpen": 500.86347270932293, "baseClose": 498.7049923387481, "baseHigh": 501.4718250512527, "baseLow": 498.0226658739439 }],
  };

  containerId = `${CONTAINER_ID}_${Math.random()}`;
  ...
  render = () => <div id={this.containerId} style={this.getStyle()} >
  </div>
}